...
export const useLayersStore = defineStore('layers', () => {
  ...
  const layers = ref({
    ...
    planet: {
      ...
      precipitation: { visible: false, label: '降水', order: 4 },
      reliefIcons: { visible: true, label: '地貌图标', order: 4.5 },
      regions: { visible: true, label: '区域', order: 5 },
      rivers: { visible: true, label: '河流', order: 5.5 },
      routes: { visible: true, label: '路线', order: 6 },
      markers: { visible: true, label: '标记', order: 7 },
      places: { visible: true, label: '聚落地点', order: 8 },
